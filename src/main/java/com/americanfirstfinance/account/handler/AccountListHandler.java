...
public class AccountListHandler {
    ...
    public List<AccountSummary> handleAccountListRequest(String dealerId, int page) {
        ...
        List<AccountSummary> accountList = accountService.getAccountsForDealer(dealerId, page);
